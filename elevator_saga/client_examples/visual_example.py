...
"""
可视化电梯调度示例
基于simple_example，增加状态记录和Web可视化功能
"""
import json
import os
...
from elevator_saga.client_examples.simple_example import ElevatorBusController
from elevator_saga.client.proxy_models import ProxyElevator, ProxyFloor, ProxyPassenger
from elevator_saga.core.models import SimulationEvent


class VisualElevatorController(ElevatorBusController):
    """
    可视化电梯调度控制器
    在simple_example基础上增加状态记录功能，用于Web可视化
    """
    ...
    def on_init(self, elevators: List[ProxyElevator], floors: List[ProxyFloor]) -> None:
        ...
        if self.record:
            ...
            self.recording_path = str(recordings_dir / f"simulation_{timestamp}.json")
            print(f"📹 开始记录状态到: {self.recording_path}")
    ...
    def _save_recording(self) -> None:
        ...
        try:
            ...
            print(f"✅ 状态记录已保存: {self.recording_path}")
...
if __name__ == "__main__":
    # 启动可视化控制器
    algorithm = VisualElevatorController(debug=True, record=True)
    algorithm.start()
